...
internal object Stage21FashPackageLoader {
    private val descriptor = Stage21PackageDescriptor(
        ...
        coverageFile = "coverage.fash.json",
        routingRulesFile = "routing_rules.fash.yaml",
        browseRootCode = "B.FASH",
    ...
    val aliasEntries: List<AliasEntry> by lazy { aliasSeedRows.map { it.toStage21AliasEntry(notesPrefix = "stage2.1.fash") } }
