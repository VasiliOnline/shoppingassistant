...
class Stage21FashPackageLoaderTest {

    @Test
    fun coverage_required_leaves_are_reachable_via_browse_tree() {
        val coverage = Stage21FashPackageLoader.coverageGate
        val browseByCode = Stage21FashPackageLoader.browseNodes.associateBy { it.browseCode }
    ...
    fun coverage_minimums_met_for_aliases_and_golden_queries() {
        ...
        val browseLeafByCode = Stage21FashPackageLoader.browseNodes
            .asSequence()
            .mapNotNull { node ->
        ...
        val aliasesByLeaf = Stage21FashPackageLoader.aliasSeedRows
            .asSequence()
        ...
        val goldenByLeaf = Stage21FashPackageLoader.goldenQueries
            .asSequence()
    ...
    fun blocked_alias_share_is_within_coverage_limit() {
        val coverage = Stage21FashPackageLoader.coverageGate
        val rows = Stage21FashPackageLoader.aliasSeedRows
