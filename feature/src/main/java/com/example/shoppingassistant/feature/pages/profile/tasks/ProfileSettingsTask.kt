...
fun ProfileSettingsTask(
    ...
    var hideUndeliverable by remember(settings.hideUndeliverable) {
        mutableStateOf(settings.hideUndeliverable)
    }
    ...
    LaunchedEffect(language, theme, hideUndeliverable) {
        onSettingsChange(
            settings.copy(
