...
sealed interface ScreenState {
    ...
    data class Content(
        ...
        val staleAction: StateAction? = null,
    ) : ScreenState
    ...
    data class Error(
        val message: String,
        val title: String? = null,
        val type: ErrorType = ErrorType.RETRYABLE,
        val primaryAction: StateAction? = null,
        val secondaryAction: StateAction? = null,
        val icon: ImageVector? = null,
    ) : ScreenState
...
data class StateAction(
    val label: String,
    val onAction: () -> Unit,
    val type: StateActionType = StateActionType.GENERIC,
)
