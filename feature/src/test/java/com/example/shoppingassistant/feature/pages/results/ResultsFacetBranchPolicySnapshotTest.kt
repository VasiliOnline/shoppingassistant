    ...
    fun tech_phones_snapshot_orders_main_and_secondary_typed_facets() {
        val filters = buildFacetUiFilters(
            definitions = listOf(
                ...
                definition("camera_main_mp", "camera_main_mp", "TECH.PHONES", FacetDataType.RANGE),
                definition("sim_configuration", "sim_configuration", "TECH.PHONES"),
                definition("model_number", "model_number", "TECH.PHONES", FacetDataType.TEXT),
                definition("memory_card_type", "memory_card_type", "TECH.PHONES"),
                definition("os_family", "os_family", "TECH.PHONES"),
                definition("connectivity", "connectivity", "TECH.PHONES"),
