...
class UserOffersActionsServiceImpl : UserOffersActionsService {
            ...
            when (request.action) {
                UserOfferActionType.DUPLICATE -> {
                    val newOfferId = OffersTable.insert { stmt ->
                        ...
                        stmt[OffersTable.attributes] = existing[OffersTable.attributes]
                        stmt[OffersTable.description] = existing[OffersTable.description]
                        stmt[OffersTable.imageUrls] = existing[OffersTable.imageUrls]
                        stmt[OffersTable.condition] = existing[OffersTable.condition]
                        stmt[OffersTable.deliveryChannel] = existing[OffersTable.deliveryChannel]
